...
COMMENT ON COLUMN main.leads.name IS 'name of the person who applied for a new tenant';
...
COMMENT ON COLUMN main.contacts.name IS 'name of the contact of a tenant';
